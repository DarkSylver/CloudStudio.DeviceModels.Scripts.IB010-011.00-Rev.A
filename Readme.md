...
# Parsing + Configuration Script – IB010-011.00 - Rev. A

This **Parsing + Configuration** script is designed for the **IB010-011.00** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – IB010-011.00 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **IB010-011.00** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
